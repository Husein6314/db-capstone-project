...
CREATE TABLE `orderdeliverystatus` (
  ...
  UNIQUE KEY `delivery_UNIQUE` (`delivery`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orders` VALUES (1,'2023-08-10',5,10.00),(2,'2023-08-10',5,10.00),(3,'2023-08-15',3,6.00),(4,'2023-08-17',2,20.00),(5,'2023-09-01',1,5.00);
...
-- Dump completed on 2023-11-05 17:28:20
